...
List<Transaction> transactions = [
  Transaction(
    ...
    owner: users[0].email,
    concerns: [users[0].email, users[2].email, users[4].email],
  ),
  Transaction(
    ...
    date: DateTime(2023, 8, 19),
    owner: users[1].email,
    concerns: [users[1].email, users[3].email, users[5].email],
  ),
  Transaction(
    ...
    owner: users[2].email,
    concerns: [users[0].email, users[2].email, users[3].email],
  ),
  Transaction(
